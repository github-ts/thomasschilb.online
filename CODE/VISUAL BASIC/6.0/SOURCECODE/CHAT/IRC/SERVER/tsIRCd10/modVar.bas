...
Public Const Build As String = "tsIRCd 1.0"
...
Select Case args(0)
  ...
  Case "VERSION"
    SM FromSock, ":" + ServerHost + " 351 " + Clients(FromSock).Nick + " 1.0 " + ServerHost + " :Running RockIRCd for win32. Server is experimental and under development."
...
SM ToSock, ":" + ServerHost + " 002 " + Clients(ToSock).Nick + " :Your host is " + ServerHost + "[" + frmMain.sckListen(0).LocalIP + "], running " + Build + " for Windows"
