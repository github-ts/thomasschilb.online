...
Public Event ProgressUpdate(ByVal BytesSent As Double, ByVal BytesTotal As Double)
...
Dim lUploadSpeed As Long
Dim lUploadSecond As Long
...
RaiseEvent ProgressUpdate(dSendTotal, dFileSize)
...
lUploadSpeed = dSendTotal - lUploadSecond
lUploadSecond = dSendTotal
Dim lKBPS As Long
lKBPS = lUploadSpeed
